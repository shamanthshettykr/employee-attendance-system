  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'radial-gradient(at 40% 20%, rgba(99, 102, 241, 0.1) 0px, transparent 50%), radial-gradient(at 80% 0%, rgba(249, 115, 22, 0.08) 0px, transparent 50%), radial-gradient(at 0% 50%, rgba(99, 102, 241, 0.05) 0px, transparent 50%)',
        'gradient-subtle': 'linear-gradient(135deg, rgba(99, 102, 241, 0.03) 0%, rgba(249, 115, 22, 0.03) 100%)',
